...
against it stood. The settler scores delivered work between 40 and 95 (base
70, moved by the artifact and the critic's pass; a baked kit artifact is fixed
at 95) and a non-delivery at 20, so at equal weight the two ratings on a
disputed step average between **15 and 52.5**.
